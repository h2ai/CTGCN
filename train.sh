...
# python3 main.py --config=config/$name.json --task=embedding --method=DynGEM > ./logs/out_ye
...
python3 main.py --config=config/$name.json --task=embedding --method=DynAERNN > ./logs/out_yelp_DynAERNN 2>&1
...
python3 main.py --config=config/$name.json --task=embedding --method=DynAE > ./logs/out_yelp_s_DynAE.txt 2>&1
python3 main.py --config=config/$name.json --task=embedding --method=DynRNN > ./logs/out_yelp_s_DynRNN.txt 2>&1
python3 main.py --config=config/$name.json --task=embedding --method=DynAERNN  > ./logs/out_yelp_s_DynAERNN.txt 2>&1
...
# python3 main.py --config=config/$name.json --task=embedding --method=DynGEM
# python3 main.py --config=config/$name.json --task=embedding --method=DynAE
python3 main.py --config=config/$name.json --task=embedding --method=DynRNN > ./logs/out_dblp_four_area_DynRNN.txt 2>&1
...
# python3 main.py --config=config/$name.json --task=embedding --method=DynGEM
python3 main.py --config=config/$name.json --task=embedding --method=DynAE > ./logs/out_dblp_four_area_s_DynAE.txt 2>&1
python3 main.py --config=config/$name.json --task=embedding --method=DynRNN > ./logs/out_dblp_four_area_s_DynRNN.txt 2>&1
python3 main.py --config=config/$name.json --task=embedding --method=DynAERNN > ./logs/out_dblp_four_area_s_DynAERNN.txt 2>&1
